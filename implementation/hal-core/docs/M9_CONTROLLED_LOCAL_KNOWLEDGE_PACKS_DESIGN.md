...
Personal/private document ingestion is explicitly out of scope. Any such admission requires a separate future Owner-authorized Reality Boundary proposal.
...
- no private or user-document ingestion;
