...
const M9_ACTIVATE_ALLOWED_ACTION = "m9_owner_pack_activation_request";
const M9_DEACTIVATE_ALLOWED_ACTION = "m9_owner_pack_deactivation_request";
...
export function evaluateLocalPolicy(request: LocalRequest, safeMode: SafeMode): AuthorityDecision {
  ...
  if (
    ...
    action === M6_ALLOWED_ACTION ||
    action === M9_ACTIVATE_ALLOWED_ACTION ||
    action === M9_DEACTIVATE_ALLOWED_ACTION
  ) {
    return createAuthorityDecision(
      "allow",
...
export const LOCAL_POLICY_ACTIONS = Object.freeze({
  ALLOWED_ACTION,
  M6_ALLOWED_ACTION,
  M9_ACTIVATE_ALLOWED_ACTION,
  M9_DEACTIVATE_ALLOWED_ACTION,
