#!/usr/bin/env node
/** Bounded stateless terminal UI for the active HAL-owned knowledge pack. */
...
process.stdout.write(
  "HAL Canon assistant (bounded, stateless; type /exit to end). Context is non-canonical; no tools or resource capabilities are available.\n"
);
...
readline.close();
process.stdout.write("HAL Canon assistant session ended.\n");
