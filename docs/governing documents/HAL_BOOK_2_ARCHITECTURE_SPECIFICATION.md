...
| Execution plane | Execution Orchestrator, capability contracts, providers, node runtimes, adapters, transactions. | Bounded execution; cannot alter constitutional state directly. |
...
HAL Core — Constitutional Kernel + Governed Services
        ...
        └── Execution Orchestrator
                 ↓ capability contract + delegated authority
HAL Node Runtimes & Governed Providers
