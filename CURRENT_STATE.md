...
4. Consolidate the validated zero-capability CLI and fixed read-only repository-status paths into HAL-owned test evidence, including bounded success/failure behavior, before considering any separately Owner-gated capability proposal.
