...
4. Consolidate the validated zero-capability CLI path into HAL-owned test evidence and exercise bounded success/failure behavior before considering any separately Owner-gated capability proposal.
