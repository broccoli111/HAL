...
rg -q -F 'Owner-authorized working amendment; recertification pending' "$combined"
rg -q -F 'Solo-Owner Assurance Profile' "$combined"
rg -q -F 'Solo-Owner Assurance Profile' 'Documents/Book III/scripts/build_book_iii.py'
