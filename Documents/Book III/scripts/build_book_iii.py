...
def main():
    ...
    write_text(DELIV/'HAL_BOOK_III_CERTIFICATION_REPORT.md','# Book III Certification Report\n\nStatus: Draft; not certified. Sources verified; standards, controls, templates, and review records generated. Certification is pending rendered-artifact and control-catalog validation.\n')
