# RB-13 — External Domains, Constitutional Firewall, and Treaty Operations Runbook
...
Operate external exchanges only through active applicable Treaties and Constitutional Firewall admission. Trigger only from an approved change, scheduled operation, alert, or declared incident. Preconditions: named commander, authenticated identities, explicit authority, current certification, evidence capture, safe rollback or containment, and verified target.
