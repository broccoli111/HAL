# RB-15 — Emergency Changes and Constitutional Shutdown Runbook
...
Execute emergency change or constitutional shutdown under narrow, attributable, time-bounded authority. Trigger only from an approved change, scheduled operation, alert, or declared incident. Preconditions: named commander, authenticated identities, explicit authority, current certification, evidence capture, safe rollback or containment, and verified target.
