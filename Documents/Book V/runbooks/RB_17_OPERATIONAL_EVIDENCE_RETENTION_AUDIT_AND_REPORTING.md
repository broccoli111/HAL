# RB-17 — Operational Evidence Retention, Audit, and Reporting Runbook
...
Retain, protect, disclose, and dispose operational evidence according to purpose, classification, and certification needs. Trigger only from an approved change, scheduled operation, alert, or declared incident. Preconditions: named commander, authenticated identities, explicit authority, current certification, evidence capture, safe rollback or containment, and verified target.
